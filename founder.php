...
<head>
    ...
    <title>Jamia-Al-Zahra || Founder </title>
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                    ...
                    <ul class="breadcrumb-nav">
                        ...
                        <li><a href="founder.php">About Us</a></li>
                        <li>Founder</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="about-left">
                        <div class="about-title align-left">
                            <span class="wow fadeInDown" data-wow-delay=".2s">About Founder</span>
                            <h2 class="wow fadeInUp" data-wow-delay=".4s">Maulana Syed Haider Mahdi Zaidi </h2>
                ...
                <div class="col-lg-6 col-12">
                    <div class="about-right wow fadeInRight" data-wow-delay=".4s">
                        <img src="assets/images/about/founder-cover.png" alt="#">
                    </div>
                </div>
            </div>
        </div>
